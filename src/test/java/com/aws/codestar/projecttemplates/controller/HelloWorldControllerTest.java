...
import com.vtt.training.vttface.biz.controller.VttFaceController;

import static org.junit.jupiter.api.Assertions.assertEquals;

/**
 * Tests for {@link VttFaceController}. Modify the tests in order to support your use case as you build your project.
 */
...
class HelloWorldControllerTest {
    ...
    private final VttFaceController controller = new VttFaceController();
    ...
    /**
     * Basic test to verify the result obtained when calling {@link VttFaceController#helloWorldGet} successfully.
     */
    @Test
...
//        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
    ...
    /**
     * Basic test to verify the result obtained when calling {@link VttFaceController#helloWorldPost} successfully.
     */
    @Test
